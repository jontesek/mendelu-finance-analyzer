...
class TwitterDbModel(DbModel):
    ...
    def add_tweets(self, tw_data):
        ...
        query = ("REPLACE INTO tw_status (tw_id, company_id, tweet_type, created_at, favorite_count, retweet_count, text, "
                 "reply_to_status_id, place_name, place_country, user_id, followers_count, friends_count, statuses_count, "
                 "user_location, download_timestamp, entities, contributors, "
                 "is_truncated, is_quoted_status, is_retweeted_status, coordinates, in_reply_to_user_id, lang) "
