...
for (n_price_type, n_delay, n_boundary) in params_combinations:
    ...
    d_exporter.process_documents_for_selected_companies(company_ids, 'tweet', from_date, to_date, n_delay, n_price_type,
